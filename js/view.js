...
(function (window) {
    ...
    View.prototype._setAsDone = function (id, checked) {
        console.log("#View > _setAsDone: id,checked:",id,checked);
        var listItem = qs('[data-id="' + id + '"]');
        ...
        var input = qs('input.status', listItem);
    ...
    View.prototype.render = function (viewCmd, parameter) {
        ...
        var viewCommands = {
            ...
            setAsDone: function () {
                that._setAsDone(parameter.id, parameter.done);
            }
        };
    ...
    View.prototype.bind = function (event, handler) {
        ...
        if (event === 'newTodo') {
            ...
            var el = qs('#clear-completed');
            $on(el, 'click', function () {
                handler();
            });

        } else if (event === 'setAsDone') {
            $live('#todo-list li input', 'click', function () {
                console.log("#View > bind > setAsDone: this.checked=",this.checked);
                handler({id: that._itemId(this), checked: this.checked});
            });
